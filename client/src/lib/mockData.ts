...
export const mockArtworks: Artwork[] = [
  { id: '1', artistId: 'a1', artist: { user: { name: 'Priya Sharma' } }, title: 'Ethereal Dawn', description: 'A mesmerizing watercolor capturing the golden hour over Varanasi ghats', price: 24500, category: 'Painting', medium: 'Watercolor', dimensions: { width: 24, height: 36, unit: 'inches' }, images: ['/placeholder-art.jpg'], status: 'LISTED', viewCount: 342, createdAt: '2026-03-15' },
  { id: '2', artistId: 'a2', artist: { user: { name: 'Ravi Kumar' } }, title: 'Kathak in Motion', description: 'Bronze sculpture capturing the grace of Kathak dance', price: 85000, category: 'Sculpture', medium: 'Bronze', dimensions: { width: 12, height: 18, unit: 'inches' }, images: ['/placeholder-art.jpg'], status: 'LISTED', viewCount: 518, createdAt: '2026-03-10' },
  { id: '3', artistId: 'a3', artist: { user: { name: 'Ananya Patel' } }, title: 'Digital Mandala', description: 'Intricate digital mandala blending traditional patterns with modern aesthetics', price: 12000, category: 'Digital Art', medium: 'Digital', dimensions: { width: 4000, height: 4000, unit: 'px' }, images: ['/placeholder-art.jpg'], status: 'LISTED', viewCount: 892, createdAt: '2026-03-12' },
  { id: '4', artistId: 'a1', artist: { user: { name: 'Priya Sharma' } }, title: 'Monsoon Rhapsody', description: 'Oil painting depicting the dramatic monsoon skies of Kerala', price: 45000, category: 'Painting', medium: 'Oil on Canvas', dimensions: { width: 36, height: 48, unit: 'inches' }, images: ['/placeholder-art.jpg'], status: 'LISTED', viewCount: 267, createdAt: '2026-03-08' },
  { id: '5', artistId: 'a4', artist: { user: { name: 'Vikram Singh' } }, title: 'Peacock Silk Weave', description: 'Hand-woven silk textile with intricate peacock motifs', price: 35000, category: 'Textile', medium: 'Silk', dimensions: { width: 48, height: 72, unit: 'inches' }, images: ['/placeholder-art.jpg'], status: 'LISTED', viewCount: 179, createdAt: '2026-03-05' },
  { id: '6', artistId: 'a5', artist: { user: { name: 'Meera Nair' } }, title: 'Temple Bells', description: 'Mixed media capturing the spiritual essence of South Indian temples', price: 28000, category: 'Mixed Media', medium: 'Mixed Media', dimensions: { width: 24, height: 24, unit: 'inches' }, images: ['/placeholder-art.jpg'], status: 'LISTED', viewCount: 441, createdAt: '2026-03-01' },
  { id: '7', artistId: 'a3', artist: { user: { name: 'Ananya Patel' } }, title: 'Neon Ganesha', description: 'Contemporary digital interpretation of Lord Ganesha in neon aesthetics', price: 8500, category: 'Digital Art', medium: 'Digital', dimensions: { width: 3000, height: 4000, unit: 'px' }, images: ['/placeholder-art.jpg'], status: 'LISTED', viewCount: 1203, createdAt: '2026-02-28' },
  { id: '8', artistId: 'a2', artist: { user: { name: 'Ravi Kumar' } }, title: 'The Potter', description: 'Terracotta figurine celebrating traditional Indian pottery artisans', price: 18000, category: 'Sculpture', medium: 'Terracotta', dimensions: { width: 8, height: 14, unit: 'inches' }, images: ['/placeholder-art.jpg'], status: 'LISTED', viewCount: 312, createdAt: '2026-02-25' },
];
